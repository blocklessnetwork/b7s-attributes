...
require (
	...
	github.com/ipfs-cluster/ipfs-cluster v1.0.6 // indirect
	...
	github.com/ipfs/go-mfs v0.2.2 // indirect
...
replace github.com/alanshaw/go-carbites v0.6.0 => ../../web3storage/go-carbites
